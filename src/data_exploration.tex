...
The visualization of somewhow parwaise connected data is ganining popularity in a broad variety of research fields. Firstly, cause it as an attractive way to present the data, and facilitates the communication of complex interdependences.

Beyond the visualization, however, there is a variety of mathematical methods available to run statistical analysis over the data underlying the visualization. This makes the approach interesting as well for researchers using the coventional statistical approach.

Thus, what is the advantage or the additonal benefit, to have data that can be represented as a network? 
   

\subsubsection{Short introduction to Graph Theory}
\label{subsubsec:graph_intro}

\subsubsection{Social networks}
\label{subsubsec:graph_social}

\subsubsection{Exploring the graph with miceminer}
