...
or if:
% I had to rewrite this part. I can barely understand it... -tnetter 16/09/2009 14:19 
\begin{mylist}
...
% Rico, I already told you not to put the exact values in the text. It's ridiculous! -tnetter 16/09/2009 14:40 
...
In figure \ref{fig:dataset_overlap} four other antenna readings could be found, two of them happen not to be from the same box. This \textit{stay result} will be discarded, as we don't know what really happened.
...
% All animals are "it", not "she" or "he", except maybe in pet stories and children books -tnetter 16/09/2009 15:29 
...
% Please rewrite this paragraph. I don't want to see those precise numbers. -tnetter 16/09/2009 15:34 
...
\begin{mylist}
\item Two \textit{stay results}, % what?????? -tnetter 16/09/2009 15:39 
\item of two different transpondered mice, % This is not how one uses a list. Please rewrite. I don't understand -tnetter 16/09/2009 15:39 
...
% Chapter conclusion? -tnetter 16/09/2009 15:44 
