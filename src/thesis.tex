...
\begin{tabularx}{\textwidth}{+>{\raggedleft\arraybackslash}H^X}
 ...
 \hline
Model	& 	Dell Inspiron 530 \\ \hline
Processor	&	Intel(R) Core(TM)2 Duo CPU E7200  @ 2.53GHz, 2525 MHz \\ \hline
Memory (RAM)	&	2 GB \\ \hline
Operating system		&	Linux version 2.6.27-7-server  (gcc version 4.3.2 (Ubuntu 4.3.2-1ubuntu11) ) \\ \hline
IP-address	&	130.60.23.6 \\ \hline
Webserver	&	Apache/2.2.9 (Ubuntu) \\ \hline
SSH	&	OpenSSH 5.1p1  \\ \hline
PHP	version	&	5.2.6-2ubuntu4 \\ \hline
