...
\begin{figure}[htpb]% 
	...
	\caption[Network visualizations of the inner- and inter-sex networks]{Visualizations of the inter- and inner-sex networks for January 2009 with the edge filter value set to 30 hours.}
